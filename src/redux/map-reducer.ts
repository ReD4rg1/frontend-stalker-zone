...
type InitialStateType = Array<ILocation>
...
let initialState: InitialStateType = [
    ...
    /*Добавить остальные локации*/
];

const mapReducer = (state = initialState, action: { type: string }) => {
    switch (action.type) {
        /*case GENERATE_MAP:
            Добавить генерацию для карты районов (всего 10 районов в одной и той же последовательности
            return {new state}
        */
        default:
            return state
